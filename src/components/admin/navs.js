                ...
                <div className="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <Link to="/dashboard" className="nav-link">Estadisticas</Link>
                        </li>
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" href="#" id="dropdown08" data-bs-toggle="dropdown" aria-expanded="false">Usuarios Internos</a>
                            <ul className="dropdown-menu" aria-labelledby="dropdown08">
                                <li><Link to="/newuser" className="dropdown-item">Crear Nuevo</Link></li>
                                <li><Link to="/userupdate" className="dropdown-item">Modificar Usuario</Link></li>
                                <li><Link to="/userdelete" className="dropdown-item">Eliminar Usuario</Link></li>
                            </ul>
                        </li>
                        <li className="nav-item dropdown">
